    ...
    .simpan {
        ...
        color: #fff;
                                    ...
                                    <form method="POST">
                                            ...
                                            <input class="textfield" name="nomorhp" value="<?php echo $tampil['nomorhp'];?>"/>
...
<?php 
    ...
    if ($simpan) {
        ...
        $sql = $koneksi->query("UPDATE tb_siswa SET nisn='$nisn', nama='$nama', kelas='$kelas', nomorhp='$nomorhp', jenis_kelamin='$jenis_kelamin', keterangan='$keterangan' WHERE id='$id'");
