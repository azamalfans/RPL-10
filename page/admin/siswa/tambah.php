<h2 align="center">Tambah Absensi Siswa</h2>
<style>
    h4 {
        margin-left: 20px;
        margin-top: 5px;
    ...
    .simpan {
        ...
        color: #fff;
                                    ...
                                    <form method="POST">
                                            ...
                                            <h4>Nomor WhatsApp Orang Tua/Wali</h4>
                                            <input class="textfield" name="nomorhp" required/>
...
<?php 
    ...
    if ($simpan) {
        ...
        $sql = $koneksi->query("INSERT INTO tb_siswa(nisn, nama, kelas, nomorhp, jenis_kelamin, keterangan)values('$nisn', '$nama', '$kelas', '$nomorhp', '$jenis_kelamin', '$keterangan')");
